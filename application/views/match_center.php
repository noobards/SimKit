					...
					<div class="table-mockup">
						...
						<?php if(count($pending) > 0) {
							foreach($pending as $arr)
							{
								...
								echo '<div class="td text-center"><i data-mid="'.$arr['mid'].'" title="Delete this match" ng-click="deleteMatch($event)" class="fa fa-close red cursor hover-show">&nbsp;</i>&nbsp;<a class="normal-anchor" href="MatchCenter/PreMatch/'.$arr['mid'].'"><strong>'.$arr['home'].'</strong> v/s <strong>'.$arr['away'].'</strong></a></div>';
